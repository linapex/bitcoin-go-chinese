...
//testGetDataWire测试msggetData Wire的各种编码和解码
//库存向量和协议版本的数量。
...
0x0a, 0xf0, 0x2b, 0x39, 0xc7, 0x3d, 0x8a, 0xd2, //203707号区块哈希的Tx 1
	...
	tests := []struct {
in   *MsgGetData     //要编码的邮件
out  *MsgGetData     //预期的解码消息
buf  []byte          //有线编码
...
//TestGetDataWireErrors对线编码和解码执行负测试
//以确认错误路径正常工作。
