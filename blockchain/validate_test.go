...
//TestSequenceLockActive测试SequenceLockActive函数以确保
//在所有可能的组合/方案中按预期工作。
...
//testcheckconnectblocktemplate测试checkconnectblocktemplate函数到
//确保失败。
...
//testcheckblocksanity测试checkblocksanity函数以确保其正常工作
//果不其然。
...
//testcheckserializedheight使用测试checkserializedheight函数
//各种系列化高度，并进行阴性测试以确保错误
//处理得当。
func TestCheckSerializedHeight(t *testing.T) {
//创建一个空的coinbase模板，用于下面的测试。
...
//预期的规则错误。
	...
	tests := []struct {
sigScript  []byte //序列化数据
wantHeight int32  //期望高度
err        error  //应为错误类型
	}{
//没有序列化的高度长度。
...
//block100000定义了block链的block 100000。它被用来
//试块操作。
var Block100000 = wire.MsgBlock{
	Header: wire.BlockHeader{
		Version: 1,
PrevBlock: chainhash.Hash([32]byte{ //让退伍军人高兴。
			0x50, 0x12, 0x01, 0x19, 0x17, 0x2a, 0x61, 0x04,
			0x21, 0xa6, 0xc3, 0x01, 0x1d, 0xd3, 0x30, 0xd9,
			0xdf, 0x07, 0xb6, 0x36, 0x16, 0xc2, 0xcc, 0x1f,
			0x1c, 0xd0, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,
}), //00000000002D01CFCCC21636B607DFD930D31D01C3A6214612A1719011250
MerkleRoot: chainhash.Hash([32]byte{ //让退伍军人高兴。
			0x66, 0x57, 0xa9, 0x25, 0x2a, 0xac, 0xd5, 0xc0,
			0xb2, 0x94, 0x09, 0x96, 0xec, 0xff, 0x95, 0x22,
			0x28, 0xc3, 0x06, 0x7c, 0xc3, 0x8d, 0x48, 0x85,
			0xef, 0xb5, 0xa4, 0xac, 0x42, 0x47, 0xe9, 0xf3,
}), //f3e94742aca4b5ef85488dc37c06c3282295ffec960994b2c0d5ac2a25a95766
Timestamp: time.Unix(1293623863, 0), //2010年12月29日11:57:43+0000 UTC
Bits:      0x1b04864c,               //四亿五千三百二十八万一千三百五十六
Nonce:     0x10572b0f,               //二亿七千四百一十四万八千一百一十一
	},
...
0xac, //奥普克西格
		...
		},
		{
			...
			TxIn: []*wire.TxIn{
				{
					PreviousOutPoint: wire.OutPoint{
Hash: chainhash.Hash([32]byte{ //让退伍军人高兴。
