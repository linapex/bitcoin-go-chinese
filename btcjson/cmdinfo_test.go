...
//testcmdmethod测试Cmdmethod函数以确保它重新展开预期的
//方法和错误。
...
//testmethodUsageFlags测试methodUsage函数，确保它返回
//期望的标志和错误。
...
//testmethodUsageText测试methodUsageText函数，确保它返回
//预期文本。
...
//testfieldUsage测试内部fieldUsage函数，确保它返回
//预期文本。
